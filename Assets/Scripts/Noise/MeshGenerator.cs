...
{
    public static MeshData GenerateTerrainMesh(float[,] heightMap, AnimationCurve meshHeightCurve, float heightMultiplier)
	{
		...
		for (int y = 0; y < height; y++)
		{
			...
			{
				meshData.AddVertex(ref vertexIndex, new Vector3(x + offset.x,
					heightMap[x, y] * meshHeightCurve.Evaluate(heightMap[x, y]) * heightMultiplier,
					y + offset.y));
